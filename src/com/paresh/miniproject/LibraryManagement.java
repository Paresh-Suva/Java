...
class AssignBookDetails implements Book {
    ...
    private final String bookName; // Storing Book Name
    private final String bookAuthor; // Storing Book Author
    private final int bookId; // Storing Book ID
    private final double bookPrice; // Storing Book Price
...
class Member {
    ...
    private final String memberName; // Storing Member Name
    private final int memberId; // Storing Member Id
    /* ArrayList That Can Store Object of Book */
    private final ArrayList<Book> borrowedBooks = new ArrayList<>(); // borrowedBooks Is Variable Name Of ArrayList
...
class Library {
    ...
    private final ArrayList<Book> books = new ArrayList<>(); // books Is Variable Name Of ArrayList
    private final ArrayList<Member> members = new ArrayList<>(); // members Is Variable Name Of ArrayList
    ...
    public void returnBook(Member member, Book book) {
        System.out
                .println("Attempting to return book: " + book.getBookName() + " by member: " + member.getMemberName());
