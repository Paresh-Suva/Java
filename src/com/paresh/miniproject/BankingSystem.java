...
class SBI implements BankAccount {
    ...
    public String toString() {
        return String.format("%-10s %-20s %-15d %-10.2f", getBankName(), accountHolderName, accountNumber,
                accountBalance);
    }
}
...
class BankingManagement {
    private final ArrayList<SBI> sbi = new ArrayList<>();
    private final ArrayList<BOB> bob = new ArrayList<>();
    private final ArrayList<HDFC> hdfc = new ArrayList<>();
